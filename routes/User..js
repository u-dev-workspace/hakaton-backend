...
router.post('/user/getUserInfo', authMiddleware, UserController.getUserInfo); // Новый маршрут
...
router.get('/user/getUserAnalitics/:userId', UserController.getUserAnalitics );
